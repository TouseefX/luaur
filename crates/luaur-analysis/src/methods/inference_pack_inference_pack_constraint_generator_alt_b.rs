...
//!   - translates_to -> rust_item InferencePack::InferencePack

// Dead duplicate skeleton node: the canonical ctor is implemented elsewhere.
pub fn inference_pack_inference_pack() {
    unreachable!("canonical InferencePack::inference_pack_type_pack_id_vector_refinement_id (C++ `explicit InferencePack(TypePackId, ...)`) lives in crates/luau-analysis/src/records/inference_pack.rs; this skeleton node is unused");
}
