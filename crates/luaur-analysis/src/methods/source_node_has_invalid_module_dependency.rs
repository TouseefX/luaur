...
//!   - translates_to -> rust_item SourceNode::hasInvalidModuleDependency

// Dead duplicate skeleton node: the canonical method is implemented elsewhere.
pub fn source_node_has_invalid_module_dependency() {
    unreachable!("canonical SourceNode::has_invalid_module_dependency lives in crates/luau-analysis/src/records/source_node.rs; this skeleton node is unused");
}
