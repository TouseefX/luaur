//! Faithful port of `sigintCallback` / the `replState` static from
//! `CLI/src/Repl.cpp`. Mirrors `luau-repl-cli/src/functions/sigint_callback.rs`,
//! adapted to the cli-test module layout (`lua_State` under `records::lua_state`).
