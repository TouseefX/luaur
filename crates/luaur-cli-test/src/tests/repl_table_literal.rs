...
//! Node: `cxx:Test:Luau.CLI.Test:tests/Repl.test.cpp:135:repl_table_literal`
...
//!   - translates_to -> rust_item repl_table_literal
...
fn repl_table_literal() {
    ...
    run_code(
        fixture.l as *mut _,
        &alloc::string::String::from("return {1, 2, 3, 4}"),
    );
