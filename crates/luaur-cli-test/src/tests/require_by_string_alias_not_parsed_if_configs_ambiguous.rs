...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:716:require_by_string_alias_not_parsed_if_configs_ambiguous`
...
//!   - translates_to -> rust_item require_by_string_alias_not_parsed_if_configs_ambiguous
