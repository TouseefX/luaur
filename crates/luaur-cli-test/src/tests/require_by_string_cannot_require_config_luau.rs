...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:723:require_by_string_cannot_require_config_luau`
...
//!   - translates_to -> rust_item require_by_string_cannot_require_config_luau
