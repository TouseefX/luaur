...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:390:require_by_string_cannot_require_init_luau_directly`
...
//!   - translates_to -> rust_item require_by_string_cannot_require_init_luau_directly
