...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:502:require_by_string_check_cache_after_require_init_lua`
...
//!   - translates_to -> rust_item require_by_string_check_cache_after_require_init_lua
...
fn require_by_string_check_cache_after_require_init_lua() {
    ...
    fixture
        .assert_output_contains_all(&[String::from("true"), String::from("result from init.lua")]);
