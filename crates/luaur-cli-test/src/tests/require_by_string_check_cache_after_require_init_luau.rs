...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:483:require_by_string_check_cache_after_require_init_luau`
...
//!   - translates_to -> rust_item require_by_string_check_cache_after_require_init_luau
