...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:445:require_by_string_check_cache_after_require_luau`
...
//!   - translates_to -> rust_item require_by_string_check_cache_after_require_luau
