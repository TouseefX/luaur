...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:521:require_by_string_check_cached_result`
...
//!   - translates_to -> rust_item require_by_string_check_cached_result
