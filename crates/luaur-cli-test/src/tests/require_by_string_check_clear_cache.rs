...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:556:require_by_string_check_clear_cache`
...
//!   - calls -> function luarequire_clearcache (Require/src/Require.cpp)
//!   - calls -> function lua_call (VM/src/lapi.cpp)
//!   - translates_to -> rust_item require_by_string_check_clear_cache
...
fn require_by_string_check_clear_cache() {
    ...
    use luaur_require::functions::luarequire_clearcache::luarequire_clearcache;
    ...
    unsafe {
        ...
        lua_pushcclosurek(l, Some(luarequire_clearcache), core::ptr::null(), 0, None);
        lua_call(l, 0, 0);
