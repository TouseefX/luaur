...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1124:require_by_string_export_as_function`
...
//!   - translates_to -> rust_item require_by_string_export_as_function
