...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1132:require_by_string_export_counter`
...
//!   - translates_to -> rust_item require_by_string_export_counter
