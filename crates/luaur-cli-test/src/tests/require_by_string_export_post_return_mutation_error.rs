...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1019:require_by_string_export_post_return_mutation_error`
...
//!   - translates_to -> rust_item require_by_string_export_post_return_mutation_error
