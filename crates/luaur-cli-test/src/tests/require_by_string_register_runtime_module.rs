...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:583:require_by_string_register_runtime_module`
...
//!   - translates_to -> rust_item require_by_string_register_runtime_module
