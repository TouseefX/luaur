...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:684:require_by_string_require_alias_that_does_not_exist`
...
//!   - translates_to -> rust_item require_by_string_require_alias_that_does_not_exist
