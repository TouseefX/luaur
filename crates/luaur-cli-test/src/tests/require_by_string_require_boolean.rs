...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:797:require_by_string_require_boolean`
...
//!   - translates_to -> rust_item require_by_string_require_boolean
