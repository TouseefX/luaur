...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:804:require_by_string_require_buffer`
...
//!   - translates_to -> rust_item require_by_string_require_buffer
