...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:919:require_by_string_require_chained_aliases_failure_depend_on_inner_alias`
...
//!   - translates_to -> rust_item require_by_string_require_chained_aliases_failure_depend_on_inner_alias
