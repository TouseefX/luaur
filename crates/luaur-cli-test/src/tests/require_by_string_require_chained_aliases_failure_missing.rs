...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:903:require_by_string_require_chained_aliases_failure_missing`
...
//!   - translates_to -> rust_item require_by_string_require_chained_aliases_failure_missing
