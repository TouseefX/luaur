...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:867:require_by_string_require_chained_aliases_success`
...
//!   - translates_to -> rust_item require_by_string_require_chained_aliases_success
