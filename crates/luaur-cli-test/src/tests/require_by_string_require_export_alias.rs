...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1188:require_by_string_require_export_alias`
...
//!   - translates_to -> rust_item require_by_string_require_export_alias
