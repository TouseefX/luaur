...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1180:require_by_string_require_export_compound`
...
//!   - translates_to -> rust_item require_by_string_require_export_compound
