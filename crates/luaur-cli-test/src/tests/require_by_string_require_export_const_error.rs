...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:995:require_by_string_require_export_const_error`
...
//!   - translates_to -> rust_item require_by_string_require_export_const_error
