...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1148:require_by_string_require_export_edge_cases`
...
//!   - translates_to -> rust_item require_by_string_require_export_edge_cases
