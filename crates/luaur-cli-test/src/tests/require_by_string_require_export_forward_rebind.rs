...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1164:require_by_string_require_export_forward_rebind`
...
//!   - translates_to -> rust_item require_by_string_require_export_forward_rebind
