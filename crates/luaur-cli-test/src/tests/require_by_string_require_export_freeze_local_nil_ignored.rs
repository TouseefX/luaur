...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1076:require_by_string_require_export_freeze_local_nil_ignored`
...
//!   - translates_to -> rust_item require_by_string_require_export_freeze_local_nil_ignored
