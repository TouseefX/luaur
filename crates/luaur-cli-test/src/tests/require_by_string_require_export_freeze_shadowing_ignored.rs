...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1068:require_by_string_require_export_freeze_shadowing_ignored`
...
//!   - translates_to -> rust_item require_by_string_require_export_freeze_shadowing_ignored
