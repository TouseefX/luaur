...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1060:require_by_string_require_export_frozen`
...
//!   - translates_to -> rust_item require_by_string_require_export_frozen
