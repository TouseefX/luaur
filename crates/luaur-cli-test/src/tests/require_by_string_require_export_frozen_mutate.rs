...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1156:require_by_string_require_export_frozen_mutate`
...
//!   - translates_to -> rust_item require_by_string_require_export_frozen_mutate
