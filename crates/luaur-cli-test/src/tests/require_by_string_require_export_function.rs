...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:947:require_by_string_require_export_function`
...
//!   - translates_to -> rust_item require_by_string_require_export_function
