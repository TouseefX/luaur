...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1140:require_by_string_require_export_function_rebind`
...
//!   - translates_to -> rust_item require_by_string_require_export_function_rebind
