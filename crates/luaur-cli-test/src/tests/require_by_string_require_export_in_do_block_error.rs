...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1028:require_by_string_require_export_in_do_block_error`
...
//!   - translates_to -> rust_item require_by_string_require_export_in_do_block_error
