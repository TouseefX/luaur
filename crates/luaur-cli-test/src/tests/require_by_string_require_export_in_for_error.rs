...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1036:require_by_string_require_export_in_for_error`
...
//!   - translates_to -> rust_item require_by_string_require_export_in_for_error
