...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1084:require_by_string_require_export_internal_call`
...
//!   - translates_to -> rust_item require_by_string_require_export_internal_call
