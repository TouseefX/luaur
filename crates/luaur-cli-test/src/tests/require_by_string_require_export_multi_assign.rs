...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1204:require_by_string_require_export_multi_assign`
...
//!   - translates_to -> rust_item require_by_string_require_export_multi_assign
