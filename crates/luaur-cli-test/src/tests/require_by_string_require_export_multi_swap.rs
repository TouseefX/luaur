...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1172:require_by_string_require_export_multi_swap`
...
//!   - translates_to -> rust_item require_by_string_require_export_multi_swap
