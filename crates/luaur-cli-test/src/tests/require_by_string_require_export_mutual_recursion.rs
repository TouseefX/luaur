...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:963:require_by_string_require_export_mutual_recursion`
...
//!   - translates_to -> rust_item require_by_string_require_export_mutual_recursion
