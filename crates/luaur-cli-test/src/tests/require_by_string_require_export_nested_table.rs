...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:971:require_by_string_require_export_nested_table`
...
//!   - translates_to -> rust_item require_by_string_require_export_nested_table
