...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:979:require_by_string_require_export_shadowing`
...
//!   - translates_to -> rust_item require_by_string_require_export_shadowing
