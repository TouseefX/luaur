...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:987:require_by_string_require_export_type_with_return`
...
//!   - translates_to -> rust_item require_by_string_require_export_type_with_return
