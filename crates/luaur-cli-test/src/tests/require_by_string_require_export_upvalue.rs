...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1100:require_by_string_require_export_upvalue`
...
//!   - translates_to -> rust_item require_by_string_require_export_upvalue
