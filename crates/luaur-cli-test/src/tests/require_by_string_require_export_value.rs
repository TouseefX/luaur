...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:939:require_by_string_require_export_value`
...
//!   - translates_to -> rust_item require_by_string_require_export_value
