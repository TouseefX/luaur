...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:1003:require_by_string_require_export_with_return_error`
...
//!   - translates_to -> rust_item require_by_string_require_export_with_return_error
...
fn require_by_string_require_export_with_return_error() {
    ...
    fixture.assert_output_contains_all(&[String::from("Exporting values is not compatible with top-level return")]);
}
