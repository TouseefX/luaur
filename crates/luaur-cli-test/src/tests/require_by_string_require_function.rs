...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:811:require_by_string_require_function`
...
//!   - translates_to -> rust_item require_by_string_require_function
