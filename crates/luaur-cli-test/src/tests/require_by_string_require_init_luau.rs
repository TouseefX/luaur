...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:362:require_by_string_require_init_luau`
...
//!   - translates_to -> rust_item require_by_string_require_init_luau
