...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:397:require_by_string_require_nested_inits`
...
//!   - translates_to -> rust_item require_by_string_require_nested_inits
