...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:825:require_by_string_require_number`
...
//!   - translates_to -> rust_item require_by_string_require_number
