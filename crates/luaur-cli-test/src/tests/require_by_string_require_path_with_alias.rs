...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:642:require_by_string_require_path_with_alias`
...
//!   - translates_to -> rust_item require_by_string_require_path_with_alias
