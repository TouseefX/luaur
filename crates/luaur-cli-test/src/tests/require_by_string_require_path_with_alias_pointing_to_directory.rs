...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:670:require_by_string_require_path_with_alias_pointing_to_directory`
...
//!   - translates_to -> rust_item require_by_string_require_path_with_alias_pointing_to_directory
