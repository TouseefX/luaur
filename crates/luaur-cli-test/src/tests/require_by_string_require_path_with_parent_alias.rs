...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:656:require_by_string_require_path_with_parent_alias`
...
//!   - translates_to -> rust_item require_by_string_require_path_with_parent_alias
