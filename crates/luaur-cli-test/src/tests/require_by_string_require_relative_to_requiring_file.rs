...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:348:require_by_string_require_relative_to_requiring_file`
...
//!   - translates_to -> rust_item require_by_string_require_relative_to_requiring_file
