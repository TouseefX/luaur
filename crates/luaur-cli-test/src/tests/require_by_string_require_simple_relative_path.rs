...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:334:require_by_string_require_simple_relative_path`
...
//!   - translates_to -> rust_item require_by_string_require_simple_relative_path
