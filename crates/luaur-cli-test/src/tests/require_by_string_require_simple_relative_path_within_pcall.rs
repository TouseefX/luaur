...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:341:require_by_string_require_simple_relative_path_within_pcall`
...
//!   - translates_to -> rust_item require_by_string_require_simple_relative_path_within_pcall
