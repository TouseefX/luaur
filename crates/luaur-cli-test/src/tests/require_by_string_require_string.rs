...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:832:require_by_string_require_string`
...
//!   - translates_to -> rust_item require_by_string_require_string
