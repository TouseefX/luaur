...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:383:require_by_string_require_submodule_using_self_directly`
...
//!   - translates_to -> rust_item require_by_string_require_submodule_using_self_directly
