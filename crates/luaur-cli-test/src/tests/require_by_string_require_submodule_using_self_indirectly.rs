...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:376:require_by_string_require_submodule_using_self_indirectly`
...
//!   - translates_to -> rust_item require_by_string_require_submodule_using_self_indirectly
...
fn require_by_string_require_submodule_using_self_indirectly() {
    ...
    fixture.assert_output_contains_all(&[
        String::from("true"),
        String::from("result from submodule"),
    ]);
}
