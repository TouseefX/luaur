...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:846:require_by_string_require_thread`
...
//!   - translates_to -> rust_item require_by_string_require_thread
