...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:635:require_by_string_require_unprefixed_path`
...
//!   - translates_to -> rust_item require_by_string_require_unprefixed_path
