...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:853:require_by_string_require_userdata`
...
//!   - translates_to -> rust_item require_by_string_require_userdata
