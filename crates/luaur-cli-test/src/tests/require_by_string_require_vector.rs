...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:860:require_by_string_require_vector`
...
//!   - translates_to -> rust_item require_by_string_require_vector
