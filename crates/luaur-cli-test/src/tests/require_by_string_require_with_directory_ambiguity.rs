...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:435:require_by_string_require_with_directory_ambiguity`
...
//!   - translates_to -> rust_item require_by_string_require_with_directory_ambiguity
