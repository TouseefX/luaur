...
//! Node: `cxx:Test:Luau.CLI.Test:tests/RequireByString.test.cpp:404:require_by_string_require_with_file_ambiguity`
...
//!   - translates_to -> rust_item require_by_string_require_with_file_ambiguity
