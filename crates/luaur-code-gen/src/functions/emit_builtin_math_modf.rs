...
pub fn emit_builtin_math_modf(
    ...
    call_wrap.call(&OperandX64::mem(
        ...
        1,
        R_NATIVE_CONTEXT,
        core::mem::offset_of!(NativeContext, libm_modf) as i32,
    ));
    ...
    build.vmovsd_operand_x_64_operand_x_64(luau_reg_value(ra), OperandX64::reg(XMM1));
    build.mov(
        luau_reg_tag(ra),
