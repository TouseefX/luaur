...
pub fn translate_inst_or_x(build: &mut IrBuilder, pc: *const Instruction, _pcpos: i32, c: IrOp) {
    let insn = unsafe { *pc };
    ...
    let result = build.inst_ir_cmd_ir_op_ir_op_ir_op(IrCmd::SELECT_IF_TRUTHY, lhs, lhs, rhs);
