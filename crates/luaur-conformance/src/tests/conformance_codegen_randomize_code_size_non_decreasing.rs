...
//! Node: `cxx:Test:Luau.Conformance:tests/Conformance.test.cpp:4594:conformance_codegen_randomize_code_size_non_decreasing`
...
//!   - translates_to -> rust_item conformance_codegen_randomize_code_size_non_decreasing
...
fn conformance_codegen_randomize_code_size_non_decreasing() {
    ...
    let compile = |nop_padding: bool| -> usize {
        ...
        unsafe {
            ...
            options.nop_padding = nop_padding;
