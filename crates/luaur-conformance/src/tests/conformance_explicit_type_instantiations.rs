...
//! Node: `cxx:Test:Luau.Conformance:tests/Conformance.test.cpp:1465:conformance_explicit_type_instantiations`
...
//!   - translates_to -> rust_item conformance_explicit_type_instantiations
