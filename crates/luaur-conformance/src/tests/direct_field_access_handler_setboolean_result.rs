...
//! Node: `cxx:Test:Luau.Conformance:tests/DirectFieldAccess.test.cpp:93:direct_field_access_handler_setboolean_result`
...
//!   - calls -> function lua_userdatadirectfield_setboolean (VM/src/lapi.cpp)
...
//!   - calls -> macro lua_isboolean (VM/include/lua.h)
//!   - calls -> function lua_toboolean (VM/src/lapi.cpp)
//!   - translates_to -> rust_item direct_field_access_handler_setboolean_result
...
fn direct_field_access_handler_setboolean_result() {
    ...
    use crate::functions::direct_field_access_get_non_zero_boolean::direct_field_access_get_non_zero_boolean;
