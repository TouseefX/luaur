...
//! Node: `cxx:Test:Luau.Conformance:tests/DirectFieldAccess.test.cpp:63:direct_field_access_handler_setnumber_result`
...
//!   - translates_to -> rust_item direct_field_access_handler_setnumber_result
