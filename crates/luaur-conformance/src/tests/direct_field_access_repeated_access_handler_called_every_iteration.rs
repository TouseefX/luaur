...
//! Node: `cxx:Test:Luau.Conformance:tests/DirectFieldAccess.test.cpp:133:direct_field_access_repeated_access_handler_called_every_iteration`
...
//!   - translates_to -> rust_item direct_field_access_repeated_access_handler_called_every_iteration
