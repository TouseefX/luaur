...
//! Node: `cxx:Test:Luau.Conformance:tests/FeedbackVector.test.cpp:254:feedback_vector_polymorphic_call_sealed`
...
//!   - translates_to -> rust_item feedback_vector_polymorphic_call_sealed
