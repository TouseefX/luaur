...
//! Node: `cxx:Test:Luau.Conformance:tests/FeedbackVector.test.cpp:150:feedback_vector_simple_call_sealed`
...
//!   - translates_to -> rust_item feedback_vector_simple_call_sealed
