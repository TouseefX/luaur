...
//! Node: `cxx:Test:Luau.Conformance:tests/FeedbackVector.test.cpp:179:feedback_vector_simple_call_sealed_on_inline`
...
//!   - calls -> function sealingInliner (tests/FeedbackVector.test.cpp)
//!   - calls -> method FeedbackVectorFixture::run (tests/FeedbackVector.test.cpp)
//!   - translates_to -> rust_item feedback_vector_simple_call_sealed_on_inline

#[cfg(test)]
#[test]
fn feedback_vector_simple_call_sealed_on_inline() {
    use crate::functions::sealing_inliner::sealing_inliner;
