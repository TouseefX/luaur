...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:6096:ir_lowering_bit_32_has_to_use_double_temporaries_sub`
...
//!   - translates_to -> rust_item ir_lowering_bit_32_has_to_use_double_temporaries_sub

#[cfg(test)]
#[test]
fn ir_lowering_bit_32_has_to_use_double_temporaries_sub() {
