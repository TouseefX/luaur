...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:5958:ir_lowering_bit_32_no_double_temporaries_add`
...
//!   - translates_to -> rust_item ir_lowering_bit_32_no_double_temporaries_add

#[cfg(test)]
#[test]
fn ir_lowering_bit_32_no_double_temporaries_add() {
