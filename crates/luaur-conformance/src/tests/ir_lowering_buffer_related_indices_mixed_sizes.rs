...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:5801:ir_lowering_buffer_related_indices_mixed_sizes`
...
//!   - translates_to -> rust_item ir_lowering_buffer_related_indices_mixed_sizes

#[cfg(test)]
#[test]
fn ir_lowering_buffer_related_indices_mixed_sizes() {
