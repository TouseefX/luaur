...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:5153:ir_lowering_buffer_related_indices_positive_base`
...
//!   - translates_to -> rust_item ir_lowering_buffer_related_indices_positive_base

#[cfg(test)]
#[test]
fn ir_lowering_buffer_related_indices_positive_base() {
