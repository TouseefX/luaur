...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:5193:ir_lowering_buffer_related_indices_positive_base_inverted`
...
//!   - translates_to -> rust_item ir_lowering_buffer_related_indices_positive_base_inverted

#[cfg(test)]
#[test]
fn ir_lowering_buffer_related_indices_positive_base_inverted() {
