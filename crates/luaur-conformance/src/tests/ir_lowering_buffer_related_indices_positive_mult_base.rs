...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:5668:ir_lowering_buffer_related_indices_positive_mult_base`
...
//!   - translates_to -> rust_item ir_lowering_buffer_related_indices_positive_mult_base

#[cfg(test)]
#[test]
fn ir_lowering_buffer_related_indices_positive_mult_base() {
