...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:5712:ir_lowering_buffer_related_indices_positive_mult_base_2`
...
//!   - translates_to -> rust_item ir_lowering_buffer_related_indices_positive_mult_base_2

#[cfg(test)]
#[test]
fn ir_lowering_buffer_related_indices_positive_mult_base_2() {
