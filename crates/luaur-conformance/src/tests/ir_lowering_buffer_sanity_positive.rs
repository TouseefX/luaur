...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:5508:ir_lowering_buffer_sanity_positive`
...
//!   - translates_to -> rust_item ir_lowering_buffer_sanity_positive

#[cfg(test)]
#[test]
fn ir_lowering_buffer_sanity_positive() {
