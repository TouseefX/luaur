...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:3110:ir_lowering_check_no_metatable_ssa_elim`
...
//!   - translates_to -> rust_item ir_lowering_check_no_metatable_ssa_elim

#[cfg(test)]
#[test]
fn ir_lowering_check_no_metatable_ssa_elim() {
    use crate::records::lowering_fixture::LoweringFixture;
    use crate::type_aliases::scoped_fast_flag::ScopedFastFlag;
    use luaur_common::FFlag;
    use std::ffi::CString;

    let _inst_readonly_elim = ScopedFastFlag::new(&FFlag::LuauCodegenExtraTableOpts, true);
