...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:4255:ir_lowering_custom_userdata_metamethod_direct_flow_2`
...
//!   - translates_to -> rust_item ir_lowering_custom_userdata_metamethod_direct_flow_2

#[cfg(test)]
#[test]
fn ir_lowering_custom_userdata_metamethod_direct_flow_2() {
