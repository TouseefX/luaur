...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:4287:ir_lowering_custom_userdata_metamethod_direct_flow_3`
...
//!   - translates_to -> rust_item ir_lowering_custom_userdata_metamethod_direct_flow_3

#[cfg(test)]
#[test]
fn ir_lowering_custom_userdata_metamethod_direct_flow_3() {
