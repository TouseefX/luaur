...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:4108:ir_lowering_custom_userdata_namecall_1`
...
//!   - translates_to -> rust_item ir_lowering_custom_userdata_namecall_1

#[cfg(test)]
#[test]
fn ir_lowering_custom_userdata_namecall_1() {
