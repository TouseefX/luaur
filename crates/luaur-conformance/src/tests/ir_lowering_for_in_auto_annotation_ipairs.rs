...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:3923:ir_lowering_for_in_auto_annotation_ipairs`
...
//!   - translates_to -> rust_item ir_lowering_for_in_auto_annotation_ipairs

#[cfg(test)]
#[test]
fn ir_lowering_for_in_auto_annotation_ipairs() {
