...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:6601:ir_lowering_fuzz_test_12`
...
//!   - translates_to -> rust_item ir_lowering_fuzz_test_12

#[cfg(test)]
#[test]
fn ir_lowering_fuzz_test_12() {
