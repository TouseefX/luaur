...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:6702:ir_lowering_fuzz_test_17`
...
//!   - translates_to -> rust_item ir_lowering_fuzz_test_17

#[cfg(test)]
#[test]
fn ir_lowering_fuzz_test_17() {
