...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:6501:ir_lowering_fuzz_test_6`
...
//!   - translates_to -> rust_item ir_lowering_fuzz_test_6

#[cfg(test)]
#[test]
fn ir_lowering_fuzz_test_6() {
