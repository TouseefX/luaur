...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:6521:ir_lowering_fuzz_test_7`
...
//!   - translates_to -> rust_item ir_lowering_fuzz_test_7

#[cfg(test)]
#[test]
fn ir_lowering_fuzz_test_7() {
