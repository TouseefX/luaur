...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:5073:ir_lowering_non_numerical_comparison_1`
...
//!   - translates_to -> rust_item ir_lowering_non_numerical_comparison_1

#[cfg(test)]
#[test]
fn ir_lowering_non_numerical_comparison_1() {
