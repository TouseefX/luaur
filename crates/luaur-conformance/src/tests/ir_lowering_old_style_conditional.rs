...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:6224:ir_lowering_old_style_conditional`
...
//!   - translates_to -> rust_item ir_lowering_old_style_conditional

#[cfg(test)]
#[test]
fn ir_lowering_old_style_conditional() {
