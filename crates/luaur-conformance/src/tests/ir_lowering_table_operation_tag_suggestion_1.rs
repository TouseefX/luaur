...
//! Node: `cxx:Test:Luau.Conformance:tests/IrLowering.test.cpp:7782:ir_lowering_table_operation_tag_suggestion_1`
...
//!   - translates_to -> rust_item ir_lowering_table_operation_tag_suggestion_1

#[cfg(test)]
#[test]
fn ir_lowering_table_operation_tag_suggestion_1() {
