//! Test fixture: faithful port of `compileFunction0Constants` (tests/Compiler.test.cpp).
...
pub fn compile_function_0_constants(source: &str) -> alloc::string::String {
    let mut bcb = BytecodeBuilder::new(None);
    bcb.set_dump_flags(BytecodeBuilder::DUMP_CODE | BytecodeBuilder::DUMP_CONSTANTS);
