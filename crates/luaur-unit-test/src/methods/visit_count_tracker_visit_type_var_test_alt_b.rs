...
//! Node: `cxx:Method:Luau.UnitTest:tests/TypeVar.test.cpp:356:visit_count_tracker_visit`
...
//!   - translates_to -> rust_item VisitCountTracker::visit

pub fn visit_count_tracker_visit() {
    // Overload body is provided by VisitCountTracker::visit_type_pack_id.
}
