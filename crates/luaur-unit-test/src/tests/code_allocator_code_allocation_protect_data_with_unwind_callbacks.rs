...
fn code_allocator_code_allocation_protect_data_with_unwind_callbacks() {
    use crate::functions::create_block_unwind_info_code_allocator_test_alt_b::create_block_unwind_info_code_allocator_test_alt_b;
    use crate::functions::destroy_block_unwind_info_code_allocator_test_alt_b::destroy_block_unwind_info_code_allocator_test_alt_b;
...

    {
        ...
        allocator.create_block_unwind_info =
            Some(create_block_unwind_info_code_allocator_test_alt_b);
