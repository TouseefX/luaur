...
fn code_allocator_generated_code_execution_multiple_functions_with_throw_x64() {
    ...
    #[cfg(target_arch = "x86_64")]
    {
        ...
        let f1: FunctionType = unsafe {
            core::mem::transmute(code_allocation.code_start.add(start1.location as usize))
        };
        let f2: FunctionType = unsafe {
            core::mem::transmute(code_allocation.code_start.add(start2.location as usize))
        };
