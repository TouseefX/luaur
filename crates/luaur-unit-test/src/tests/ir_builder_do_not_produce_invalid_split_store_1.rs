...
fn ir_builder_do_not_produce_invalid_split_store_1() {
    ...
    let mut fix = IrBuilderFixture::new();
    {
        ...
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_INT, r0, one);
        let r0 = b.vm_reg(0);
        let tag = b.inst_ir_cmd_ir_op(IrCmd::LOAD_TAG, r0);
        let ttable = b.const_tag(lua_Type::LUA_TTABLE as u8);
        let exit = b.vm_exit(1);
        b.inst_ir_cmd_ir_op_ir_op_ir_op(IrCmd::CHECK_TAG, tag, ttable, exit);
        let r0 = b.vm_reg(0);
