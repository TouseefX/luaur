...
fn ir_builder_dse_vm_exit_sync_deep_sink_chain() {
    ...
    let mut fix = IrBuilderFixture::new();
    {
        ...
        let add1 = b.inst_ir_cmd_ir_op_ir_op(IrCmd::ADD_NUM, load, one);
        let two = b.const_double(2.0);
        let add2 = b.inst_ir_cmd_ir_op_ir_op(IrCmd::ADD_NUM, add1, two);
        let three = b.const_double(3.0);
        let add3 = b.inst_ir_cmd_ir_op_ir_op(IrCmd::ADD_NUM, add2, three);
        let r1 = b.vm_reg(1);
        let tnumber = b.const_tag(TNUMBER);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_TAG, r1, tnumber);
        let r1 = b.vm_reg(1);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_DOUBLE, r1, add3);
        let r2 = b.vm_reg(2);
