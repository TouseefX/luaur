...
fn ir_builder_forgprep_invalidation() {
    ...
    let mut fix = IrBuilderFixture::new();
    {
        ...
        let r0 = b.vm_reg(0);
        let tbl = b.inst_ir_cmd_ir_op(IrCmd::LOAD_POINTER, r0);
        let exit = b.vm_exit(1);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::CHECK_READONLY, tbl, exit);

        let pc = b.const_uint(2);
        let r1 = b.vm_reg(1);
        b.inst_ir_cmd_ir_op_ir_op_ir_op(IrCmd::FALLBACK_FORGPREP, pc, r1, followup);
