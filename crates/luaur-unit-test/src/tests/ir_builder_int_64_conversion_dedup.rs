...
fn ir_builder_int_64_conversion_dedup() {
    ...
    let mut fix = IrBuilderFixture::new();
    {
        ...
        let r0 = b.vm_reg(0);
        let dbl = b.inst_ir_cmd_ir_op(IrCmd::LOAD_DOUBLE, r0);
        let i1 = b.inst_ir_cmd_ir_op(IrCmd::NUM_TO_INT64, dbl);
        let i2 = b.inst_ir_cmd_ir_op(IrCmd::NUM_TO_INT64, dbl);
        let r1 = b.vm_reg(1);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_INT64, r1, i1);
        let r2 = b.vm_reg(2);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_INT64, r2, i2);
