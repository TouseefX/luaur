...
fn ir_builder_int_64_num_roundtrip_elimination() {
    ...
    let mut fix = IrBuilderFixture::new();
    {
        ...
        let r0 = b.vm_reg(0);
        let int_val = b.inst_ir_cmd_ir_op(IrCmd::LOAD_INT64, r0);
        let dbl_val = b.inst_ir_cmd_ir_op(IrCmd::INT64_TO_NUM, int_val);
        let back_to_int = b.inst_ir_cmd_ir_op(IrCmd::NUM_TO_INT64, dbl_val);
        let r1 = b.vm_reg(1);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_INT64, r1, back_to_int);
