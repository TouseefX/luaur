...
fn ir_builder_int_num_int_peepholes_2() {
    ...
    let mut fix = IrBuilderFixture::new();
    {
        ...
        let r0 = b.vm_reg(0);
        let d1 = b.inst_ir_cmd_ir_op(IrCmd::LOAD_DOUBLE, r0);
        let u = b.inst_ir_cmd_ir_op(IrCmd::NUM_TO_UINT, d1);
        let d2 = b.inst_ir_cmd_ir_op(IrCmd::UINT_TO_NUM, u);
        let to_uint = b.inst_ir_cmd_ir_op(IrCmd::NUM_TO_UINT, d2);
        let r0 = b.vm_reg(0);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_INT, r0, to_uint);
        let r0 = b.vm_reg(0);
