...
fn ir_builder_load_propagates_only_right_type() {
    ...
    let mut fix = IrBuilderFixture::new();
    {
        ...
        let r0 = b.vm_reg(0);
        let value1 = b.inst_ir_cmd_ir_op(IrCmd::LOAD_DOUBLE, r0);
        let r1 = b.vm_reg(1);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_DOUBLE, r1, value1);
        let r1 = b.vm_reg(1);
        let value2 = b.inst_ir_cmd_ir_op(IrCmd::LOAD_INT, r1);
        let r2 = b.vm_reg(2);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_INT, r2, value2);
