...
fn ir_builder_no_dead_value_reuse() {
    ...
    let mut fix = IrBuilderFixture::new();
    {
        ...
        let op2i = b.inst_ir_cmd_ir_op(IrCmd::NUM_TO_INT, op1);
        let sum = b.inst_ir_cmd_ir_op_ir_op(IrCmd::ADD_INT, res, op2i);
        let resd = b.inst_ir_cmd_ir_op(IrCmd::INT_TO_NUM, sum);
        let r1 = b.vm_reg(1);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_DOUBLE, r1, resd);
        let r1 = b.vm_reg(1);
