...
fn ir_builder_partial_over_full_value() {
    ...
    let mut fix = IrBuilderFixture::new();
    {
        ...
        b.inst_ir_cmd_ir_op_ir_op_ir_op(IrCmd::STORE_SPLIT_TVALUE, r0, tnumber, one);
        let r0 = b.vm_reg(0);
        ...
        b.inst_ir_cmd_ir_op_ir_op_ir_op(IrCmd::STORE_SPLIT_TVALUE, r0, ttable, table);
        let eight = b.const_uint(8);
        let sixteen = b.const_uint(16);
        let table = b.inst_ir_cmd_ir_op_ir_op(IrCmd::NEW_TABLE, eight, sixteen);
        let r0 = b.vm_reg(0);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_POINTER, r0, table);
        let four = b.const_uint(4);
        let eight = b.const_uint(8);
        let table = b.inst_ir_cmd_ir_op_ir_op(IrCmd::NEW_TABLE, four, eight);
        let r0 = b.vm_reg(0);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_POINTER, r0, table);
        let r0 = b.vm_reg(0);
        let tnumber = b.const_tag(TNUMBER);
        ...
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_TAG, r0, tstring);
        let sixteen = b.const_uint(16);
        let thirty_two = b.const_uint(32);
        let newtable = b.inst_ir_cmd_ir_op_ir_op(IrCmd::NEW_TABLE, sixteen, thirty_two);
        let r0 = b.vm_reg(0);
        let ttable = b.const_tag(TTABLE);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_TAG, r0, ttable);
        let r0 = b.vm_reg(0);
