...
fn ir_builder_partial_vs_full_stores_no_removal_2() {
    ...
    let mut fix = IrBuilderFixture::new();
    {
        ...
        let value = b.inst_ir_cmd_ir_op_ir_op_ir_op(IrCmd::LOAD_TVALUE, r1, zero, tnumber);
        let r0 = b.vm_reg(0);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_TVALUE, r0, value);
        let r0 = b.vm_reg(0);
        let one = b.const_double(1.0);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_DOUBLE, r0, one);
        let r2 = b.vm_reg(2);
        let value = b.inst_ir_cmd_ir_op(IrCmd::LOAD_DOUBLE, r2);
        let r0 = b.vm_reg(0);
        let tnumber = b.const_tag(TNUMBER);
        b.inst_ir_cmd_ir_op_ir_op_ir_op(IrCmd::STORE_SPLIT_TVALUE, r0, tnumber, value);
        let r0 = b.vm_reg(0);
