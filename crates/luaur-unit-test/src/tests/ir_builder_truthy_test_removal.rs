...
fn ir_builder_truthy_test_removal() {
    ...
    let mut fix = IrBuilderFixture::new();
    {
        ...
        b.begin_block(block);
        let r1 = b.vm_reg(1);
        let unknown = b.inst_ir_cmd_ir_op(IrCmd::LOAD_TAG, r1);
        let tnumber = b.const_tag(TNUMBER);
        b.inst_ir_cmd_ir_op_ir_op_ir_op(IrCmd::CHECK_TAG, unknown, tnumber, fallback);
        let r1 = b.vm_reg(1);
        b.inst_ir_cmd_ir_op_ir_op_ir_op(IrCmd::JUMP_IF_TRUTHY, r1, true_block, false_block);
