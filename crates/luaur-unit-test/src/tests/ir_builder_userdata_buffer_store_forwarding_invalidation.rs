...
fn ir_builder_userdata_buffer_store_forwarding_invalidation() {
    ...
    let mut fix = IrBuilderFixture::new();
    {
        ...
        let ud = b.inst_ir_cmd_ir_op_ir_op(IrCmd::NEW_USERDATA, sixteen, one);
        ...
        let four = b.const_int(4);
        let tuserdata = b.const_tag(TUSERDATA);
        let loaded = b.inst_ir_cmd_ir_op_ir_op_ir_op(IrCmd::BUFFER_READI32, ud, four, tuserdata);
        let r0 = b.vm_reg(0);
        b.inst_ir_cmd_ir_op_ir_op(IrCmd::STORE_INT, r0, loaded);
        let r0 = b.vm_reg(0);
