...
//! Node: `cxx:Test:Luau.UnitTest:tests/OverloadResolver.test.cpp:203:overload_resolver_new_overloads_with_different_arities_1`
...
//!   - translates_to -> rust_item overload_resolver_new_overloads_with_different_arities_1
...
#[cfg(test)]
#[test]
fn overload_resolver_new_overloads_with_different_arities1() {
