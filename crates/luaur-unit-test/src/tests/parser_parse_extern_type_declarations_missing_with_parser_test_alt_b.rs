//! Node: `cxx:Test:Luau.UnitTest:tests/Parser.test.cpp:2299:parse_extern_type_declarations_missing_with`
...
fn parser_parse_extern_type_declarations_missing_with() {
    ...
    let stat = result.root;
    assert_eq!(unsafe { (*stat).body.size }, 2);
