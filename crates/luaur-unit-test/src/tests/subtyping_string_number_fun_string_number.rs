...
#[cfg(test)]
#[test]
fn subtyping_string_number_fun_string_number() {
    ...
    let super_ty = fixture.meet(not_function_ty, number_to_string_ty);

    assert!(!fixture
        .is_subtype_type_id_type_id(number_to_string_ty, super_ty)
        .is_subtype());
}
