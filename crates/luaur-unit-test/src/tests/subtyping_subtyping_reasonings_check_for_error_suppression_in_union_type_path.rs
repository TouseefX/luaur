...
#[cfg(test)]
#[test]
fn subtyping_subtyping_reasonings_check_for_error_suppression_in_union_type_path() {
    let mut fixture = SubtypeFixture::default();
    let number_ty = fixture.builtin_types.numberType;
    let error_ty = fixture.builtin_types.errorType;
    let boolean_ty = fixture.builtin_types.booleanType;

    let sub_ty = fixture.arena.add_type(UnionType {
        options: vec![number_ty, error_ty],
    });
    let super_ty = boolean_ty;
    ...
    for reasoning in result.reasoning().iter() {
        ...
        assert_eq!(Some(error_ty), opt_sub_leaf);
    }
}
