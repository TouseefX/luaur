...
fn type_function_a_tf_parameterized_on_a_stuck_tf_is_stuck() {
    ...
    let buffer_type = fixture.builtin_types.bufferType;
    let boolean_type = fixture.builtin_types.booleanType;
    ...
    let tfit = unsafe { get_type_id::<TypeFunctionInstanceType>(outer_add_ty).as_ref() }
